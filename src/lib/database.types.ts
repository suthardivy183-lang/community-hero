  ...
  public: {
    Tables: {
      ...
      categories: {
        ...
        Relationships: [
          {
            foreignKeyName: "categories_default_department_id_fkey"
      ...
      confirmations: {
        ...
        Relationships: [
          {
            foreignKeyName: "confirmations_issue_id_fkey"
            columns: ["issue_id"]
            isOneToOne: false
            referencedRelation: "issues"
            referencedColumns: ["id"]
      ...
      escalations: {
        ...
        Relationships: [
          {
            foreignKeyName: "escalations_issue_id_fkey"
            columns: ["issue_id"]
            isOneToOne: false
            referencedRelation: "issues"
            referencedColumns: ["id"]
      ...
      issue_media: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "issue_media_uploader_id_fkey"
            columns: ["uploader_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      status_history: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "status_history_issue_id_fkey"
            columns: ["issue_id"]
            isOneToOne: false
            referencedRelation: "issues"
            referencedColumns: ["id"]
      ...
      validations: {
        ...
        Relationships: [
          {
            foreignKeyName: "validations_after_media_id_fkey"
            columns: ["after_media_id"]
            isOneToOne: false
            referencedRelation: "issue_media"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "validations_before_media_id_fkey"
          ...
          {
            foreignKeyName: "validations_issue_id_fkey"
            columns: ["issue_id"]
            isOneToOne: false
            referencedRelation: "issues"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      evaluate_badges: { Args: { target: string }; Returns: undefined }
      ...
      trigger_escalations: { Args: never; Returns: number }
