...
const tabTrigger =
  'inline-flex shrink-0 items-center gap-1.5 border-b-2 px-3 py-2.5 text-sm font-semibold transition-colors data-[state=active]:border-primary data-[state=active]:text-primary border-transparent text-muted hover:text-ink'
    ...
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6">
      <div className="mb-5 flex min-w-0 items-start gap-3 sm:items-center">
        ...
        <div className="min-w-0">
          <h1 className="font-display text-2xl font-semibold sm:text-3xl">Authority dashboard</h1>
      ...
      {isLoading ? (
        ...
        <Tabs.Root value={tab} onValueChange={setTab}>
          <Tabs.List className="mb-5 flex w-full max-w-full gap-1 overflow-x-auto overscroll-x-contain border-b border-border" aria-label="Dashboard sections">
